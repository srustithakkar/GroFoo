...
import b_contact_img from "../assets/images/b_contact_img.png";
          ...
          <div className="container">
            <div className="navbar-header page-scroll">
              ...
              <a className="navbar-brand" href="index.html">
                <img src={header_logo} alt="" className="logo_c" />{" "}
              </a>
            </div>
            <div
            ...
            >
              {/* <ul className="nav navbar-nav navbar-right">
                                <li className="dropdown  notify">
                                    <a href="Business_Home.html" className="dropdown-toggle">
                                        Home
                                    </a>
                                </li>
                                <li className="dropdown  notify">
                                    <a href="Business_contact_us.html" className="dropdown-toggle">
                                        Contact Us
                                    </a>
                                </li>
                                <li className="dropdown  notify">
                                    <a href="Business_Register.html" className="dropdown-toggle">
                                        Register with Us
                                    </a>
                                </li>

                                <a className="btn btn-nav-line" href="Business_Login.html"> <i className="ion-ios-contact-outline"></i> Business Login
                                </a>
                            </ul> */}
            </div>
          </div>
              ...
              <div className="row">
                <div className="c-u-p-heading-box col-sm-12">
                  ...
                  <p className="c-u-p-subtext">
                    Please leave your contact details here and we’ll get back to
                    you within <br />
                    24 hours or give us a missed call here
                  </p>
                  <span className="support-call">
                    Call us at +91-80396 54500
                  </span>
                </div>
              ...
              <div className="cart-box">
                ...
                <div className="cart-list-scroll">
                  <div className="cart-list-box">
                    <img className="cart-img" src={pro_68615} alt="" />
                    ...
                    <div className="tab-pane active" role="tabpanel" id="step1">
                      <div className="check-title-box">
                        ...
                        <div className="check-add-btn">
                          <a href="/" dataToggle="modal" dataTarget="#myModal4">
                            {" "}
